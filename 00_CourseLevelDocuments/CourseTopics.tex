...
\begin{frame}{Python half: 12 classes}
  ...
  \begin{tabular}{ccll}
    ...
    3 & 5  &           & Search and sorting algorithms ?? \\
      & 6  & $\checkmark$ & Python midterm 1 \\
    4 & 7  &           & Modules, dates, and the \texttt{math} module \\
      & 8  & $\checkmark$ & Pandas I \\
    5 & 9  &           & Pandas II \\
      & 10 & $\checkmark$ & Data visualization \\
    6 & 11 &          & Practice and preparation for midterm 2 \\
      & 12 &          & Midterm \\
    \bottomrule
  \end{tabular}
\end{frame}
